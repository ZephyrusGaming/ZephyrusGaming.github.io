                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="stats.html"><i class="fa fa-bar-chart-o"></i> Stats</a>
                            </li>
                        </ul>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 clearfix">
                <div class="thumbnail">
                    <h2 class="text-center smallmargin">Server 1</h2>
...
echo $info['MaxPlayers'];
            ...
            <div class="col-md-4 clearfix">
                <div class="thumbnail">
                    <h2 class="text-center smallmargin">Server 2</h2>
...
echo $info['MaxPlayers'];
            ...
            <div class="col-md-4 clearfix">
                <div class="thumbnail">
                    <h2 class="text-center smallmargin">Server 3</h2>
...
echo $info['MaxPlayers'];
            ...
            <div class="col-md-4 clearfix">
                <div class="thumbnail">
                    <h2 class="text-center smallmargin">Server 4</h2>
...
echo $info['MaxPlayers'];
            ...
            <div class="col-md-4 clearfix">
                <div class="thumbnail">
                    <h2 class="text-center smallmargin">Server 5</h2>
...
echo $info['MaxPlayers'];
            ...
            <div class="col-md-4 clearfix">
                <div class="thumbnail">
                    <h2 class="text-center smallmargin">Server 6</h2>
